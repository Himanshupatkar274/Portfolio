                  ...
                  <div className="row">
                    ...
                    <ul className="nav">
                      <li className="nav-item">
                        ...
                        <img className="skills-img" src="https://static-00.iconduck.com/assets.00/material-ui-icon-512x406-fhnu85xg.png" alt="" />
                      </li>
                      <li className="nav-item">
                        <strong>Bootstrap</strong>
                        <img className="skills-img" src="https://getbootstrap.com/docs/5.3/assets/brand/bootstrap-logo-shadow.png" alt="" />
                      </li>
                      <li className="nav-item">
